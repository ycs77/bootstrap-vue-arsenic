...
module.exports = {
  ...
  manifest: {
    ...
    short_name: 'BootstrapVueArsenic',
    description: 'The Bootstrap Vue admin components.',
    theme_color: '#563d7c'
  },
  ...
  head: {
    ...
    script: [{ type: 'text/javascript', src: '//unpkg.com/@babel/polyfill/dist/polyfill.min.js' }]
  },
