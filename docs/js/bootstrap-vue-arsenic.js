(function (global, factory) {
	...
	(global = global || self, global.bootstrapVueArsenic = factory());
	...
	function pad(string, length, chars) {
	  ...
	  return (
	    _createPadding(nativeFloor$1(mid), chars) +
	    string +
	    _createPadding(nativeCeil$1(mid), chars)
	  );
	}
	...
	function componentIsExist(component) {
	  const componentName = string.upperFirst(string.camelCase(component));

	  let thisVueComponent;

	  try {
	    thisVueComponent = Object.keys(this.$options.components).some(c => {
	      return string.upperFirst(string.camelCase(c)) === componentName;
	    });
	  } catch (error) {}

	  const globalVueComponent = Vue.component(componentName);
	  return Boolean(thisVueComponent || globalVueComponent);
	}
	...
	var script = {
	  ...
	  methods: {
	    ...
	    hasItemChild(item, itemChildName) {
	      return this.isExistItemChildren(item) ? item.children.some(child => child.name === itemChildName) : false;
	    },
	      ...
	      _c(
	        ...
	        _vm._l(_vm.vItems, function(item) {
	          return _c(
	            ...
	            {
	              class: {
	                active: _vm.itemActive(item),
	                show: item.show
	              }
	            },
	            [
	              !_vm.isExistItemChildren(item)
	                ? [
	                    _c(
	                      "auto-link",
	                      {
	                      ...
	                      [
	                        _c("div", { staticClass: "nav-sidebar-item-icon" }, [
	                ...
	                : [
	                    _c(
	                      "div",
	                      {
	                        staticClass: "nav-sidebar-item nav-sidebar-item-switch",
	                        on: {
	                          click: function($event) {
	                            return _vm.clickItem(item, true)
	                          }
	                        }
	                      },
	                      [
	                        ...
	                        item.badge
	                          ...
	                          : _vm._e(),
	                        _vm._v(" "),
	                        _c("span", { staticClass: "nav-sidebar-sub-icon" }, [
	                          _vm._v("▾")
	                        ])
	                      ]
	                    ),
	                        ...
	                        _vm._l(item.children, function(childItem) {
	                          return _c(
	                            "li",
	                            {
	                              class: {
	                                "no-icon": true,
	                                active: _vm.itemActive(childItem)
	                              }
	                            },
	                            [
	                              _c(
	                                ...
	                                [
	                                  _c(
	                                    "div",
	                                    { staticClass: "nav-sidebar-item-name" },
	...
	var __vue_staticRenderFns__ = [
	  function() {
	    ...
	    return _c("div", { staticClass: "nav-sidebar-header" }, [
	      _c("div", { staticClass: "nav-sidebar-header-content" }, [
...
//# sourceMappingURL=bootstrap-vue-arsenic.js.map
