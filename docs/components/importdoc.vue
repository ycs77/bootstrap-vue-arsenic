...
export default {
  ...
  computed: {
    ...
    pluginImportCode() {
      ...
      return [
        `import { ${this.pluginName} } from 'bootstrap-vue-arsenic/es/${pluginLocation}/${
          this.pluginDir
        }'`,
  ...
  methods: {
    ...
    componentPath(component) {
      ...
      return `bootstrap-vue-arsenic/es/components/${this.pluginDir}/${componentName}`
    },
    ...
    directivePath(directive) {
      ...
      return `bootstrap-vue-arsenic/es/directives/${directiveName}/${directiveName}`
    }
  }
}
</script>
