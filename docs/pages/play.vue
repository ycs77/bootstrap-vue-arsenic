  ...
  <main class="container">
    <div class="mb-3 row">
      <div class="col-12 mb-3">
        ...
        <p class="mb-1">
          <strong>TIP:</strong>
          You can clone docs repo, to hack and develop components. changes will be reflected and
          hot-reloaded instantly.
        </p>
      </div>
      <div class="col-12">
...
const defaultHTML = `<div>
  <h4>Hello {{ name }}!</h4>
  <p>
    <b-button @click="toggleSize" size="sm">
...
export default {
  ...
  head() {
    const title = 'Online Playground | BootstrapVueArsenic'
  ...
  computed: {
    ...
    fiddle_dependencies() {
      return [
        ...
        '//unpkg.com/bootstrap-vue-arsenic@latest/dist/bootstrap-vue.css',
        ...
        '//unpkg.com/bootstrap-vue-arsenic@latest/dist/bootstrap-vue.js'
      ].join(',')
    },
    fiddle_js() {
      let js = this.js.trim() || '{}'
